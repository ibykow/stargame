...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Ship = (function(superClass) {
  ...
  Ship.prototype.fire = function() {
    var i;
    i = this.game.bullets.push(new Bullet(this)) - 1;
    return console.log('fired', this.game.bullets[i].position, 'from', this.position, 'at', this.player.inputSequence);
  };
  ...
  Ship.prototype.handleBulletCollisions = function() {
    ...
    for (j = 0, len = ref1.length; j < len; j++) {
      b = ref1[j];
      this.health--;
      results.push(console.log('player', b.gun.player.id, 'hit player', this.player.id, this.health));
    }
    return results;
  };
