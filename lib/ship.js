var Bullet, Config, Ship, Sprite, abs, acceleration, brake, cos, floor, max, min, ref, ref1, sin, trunc, turn,
...
ref1 = Config.common.ship.rates, acceleration = ref1.acceleration, brake = ref1.brake, turn = ref1.turn;
...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Ship = (function(superClass) {
  ...
  Ship.glideBrake = function() {
    ...
    this.isBraking = true;
    this.velocity[0] *= brake;
    return this.velocity[1] *= brake;
  };
  ...
  Ship.prototype.brake = function() {
    ...
    this.isBraking = true;
    rate = min(this.magnitude * this.magnitude / this.brakePower, brake);
