var Config, Eventable, Game, GasStation, Player, Server, ServerGame, Sprite, Util, abs, floor, isarr, ref, rnd, round, sqrt, trunc,
...
(typeof module !== "undefined" && module !== null ? module : {}).exports = ServerGame = (function(superClass) {
  ...
  ServerGame.prototype.getShipStates = function() {
    var j, len, player, ref1, results;
    ref1 = this.players;
    results = [];
    for (j = 0, len = ref1.length; j < len; j++) {
      player = ref1[j];
      results.push(player.getState());
    }
    return results;
  };
  ...
  ServerGame.prototype.updateCollisions = function() {
    return this.bullets = this.bullets.filter((function(_this) {
      return function(b) {
        var j, len, ref1, ref2, sprite, sprites, type;
        ref1 = _this.collisionSpriteLists;
        for (type in ref1) {
          sprites = ref1[type];
