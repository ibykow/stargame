...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Player = (function() {
  ...
  Player.prototype.updateInputLog = function() {
    ...
    if (this.inputs.length) {
      console.log('latest', (ref = this.latestInputLogEntry) != null ? ref.sequence : void 0, (ref1 = this.latestInputLogEntry) != null ? ref1.ship.position : void 0);
    }
    entry = {
    ...
    if (entry.inputs.length) {
      console.log(entry.ship.position);
    }
