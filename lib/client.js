...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Client = (function() {
  ...
  Client.prototype.generateInputs = function() {
    var i, j, ref, results;
    results = [];
  ...
  Client.prototype.frame = {
    run: function(timestamp) {
      this.game.player.inputs = this.generateInputs();
      if (this.game.player.inputs.length) {
        this.socket.emit('input', this.game.player.inputs);
      }
