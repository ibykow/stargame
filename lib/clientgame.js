...
(typeof module !== "undefined" && module !== null ? module : {}).exports = ClientGame = (function(superClass) {
  ...
  ClientGame.prototype.draw = function() {
    var k, l, len, len1, ref, ref1, sprite, vector;
    this.clear();
    ...
    this.c.font = "12px Courier New";
    this.c.fillText('x:' + this.player.ship.position[0].toFixed(0), 0, 8);
    this.c.fillText('y:' + this.player.ship.position[1].toFixed(0), 80, 8);
    return this.c.fillText('r:' + this.player.ship.position[2].toFixed(2), 160, 8);
  };
