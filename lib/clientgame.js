...
(typeof module !== "undefined" && module !== null ? module : {}).exports = ClientGame = (function(superClass) {
  ...
  ClientGame.prototype.processServerData = function(data) {
    var bullet, i, id, inserted, j, k, l, p, ref1, ref2, ref3, ref4, ship, state, stateLog;
    ...
    this.bullets = this.bullets.concat((function() {
  ...
  ClientGame.prototype.step = function(time) {
    ...
    this.updateMouse();
    this.player.inputs = this.player.inputs.concat(this.client.getKeyboardInputs());
    this.update();
    this.notifyServer();
    this.draw();
