...
(typeof module !== "undefined" && module !== null ? module : {}).exports = ClientGame = (function(superClass) {
  ...
  ClientGame.prototype.correctPrediction = function() {
    var entry, i, k, len, log, ref, ref1, ref2, ref3, results;
    if (!((ref = this.shipState) != null ? ref.inputSequence : void 0)) {
      return;
    }
    i = 0;
    console.log('correcting prediction');
    log = this.player.logs['input'];
    while (((ref1 = (ref2 = log.peek()) != null ? ref2.sequence : void 0) != null ? ref1 : this.shipState.sequence) < this.shipState.sequence) {
      log.remove();
    }
