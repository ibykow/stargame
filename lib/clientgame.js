var Client, ClientGame, Game, Ship, Sprite, floor, max, ref,
...
(typeof module !== "undefined" && module !== null ? module : {}).exports = ClientGame = (function(superClass) {
  ...
  function ClientGame(details, canvas, c, socket) {
    ...
    this.ships = [];
    this.history = new RingBuffer(ClientGame.HISTORY_LEN);
  ...
  ClientGame.prototype.interpolation = {
    reset: function(dt) {
      this.step = 0;
      return this.rate = Client.FRAME_MS / dt;
    }
  };
  ...
  ClientGame.prototype.correctPrediction = function() {
    var clientState, entry, inputLog, k, len, ref1, ref2, ref3, results, serverInputSequence, serverState;
    ...
    clientState = (ref2 = inputLog.remove()) != null ? ref2.ship.position : void 0;
    serverState = this.shipState.ship.position;
    if (!Util.vectorDeltaExists(clientState, serverState)) {
      return;
    }
  ...
  ClientGame.prototype.gameOver = function() {
    ...
    this.c.fillText('Game Over!', this.canvas.halfWidth - 80, this.canvas.halfHeight);
    this.c.font = '14px Courier New';
    this.c.fillText("Alright, that's it! I'm sick of it!", this.canvas.halfWidth - 135, this.canvas.halfHeight + 20);
    return this.c.fillText("Shut the fuck up, I've got a gun!", this.canvas.halfWidth - 130, this.canvas.halfHeight + 38);
  };
