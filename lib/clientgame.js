var Client, ClientGame, Game, Player, Ship, Sprite, floor, isarr, max, ref,
...
(typeof module !== "undefined" && module !== null ? module : {}).exports = ClientGame = (function(superClass) {
  ...
  ClientGame.prototype.insertBullet = function() {};
  ...
  ClientGame.prototype.correctPrediction = function() {
    var clientPosition, entries, entry, inputLog, k, len, logEntry, ref1, ref2, results, serverInputSequence, serverPosition, serverState;
    ...
    console.log(logEntry != null ? logEntry.sequence : void 0, clientPosition);
    ...
    console.log('input log', inputLog.tail, inputLog.head, (ref2 = inputLog.peek()) != null ? ref2.sequence : void 0);
  ...
  ClientGame.prototype.processServerData = function(data) {
    var arrow, bullet, i, inserted, j, k, l, len, m, p, ref1, ref2, ref3, ref4, ref5, ship, state, stateLog;
    ref1 = [false, 0, 0, this.player.logs['state']], inserted = ref1[0], i = ref1[1], j = ref1[2], stateLog = ref1[3];
    ref2 = data.bullets;
    for (k = 0, len = ref2.length; k < len; k++) {
      bullet = ref2[k];
      this.bullets.push(Bullet.fromState(this, bullet));
    }
    for (i = l = 0, ref3 = data.ships.length; 0 <= ref3 ? l < ref3 : l > ref3; i = 0 <= ref3 ? ++l : --l) {
    ...
    if (j > i) {
      ...
      for (j = m = ref4 = i, ref5 = data.ships.length; ref4 <= ref5 ? m < ref5 : m > ref5; j = ref4 <= ref5 ? ++m : --m) {
        state = data.ships[j];
        p = {
          id: state.id,
          game: this
