...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Vector = (function() {
  ...
  Vector.prototype.update = function() {
    ...
    if (this.magnitude - this.prevMagnitude > 100) {
      console.log('delta mag', this.magnitude - this.prevMagnitude);
      console.log('@a.position', this.a.position);
      console.log('@b.position', this.b.position);
      console.log('@position', this.position);
      console.log(' ');
    }
    this.prevMagnitude = this.magnitude;
