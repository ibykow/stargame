...
(typeof module !== "undefined" && module !== null ? module : {}).exports = GasStation = (function(superClass) {
  ...
  function GasStation(parent, fuelPrice) {
    ...
    GasStation.__super__.constructor.call(this, this.parent.game);
    ...
    this.parent.adopt(this, 'GasStation');
  }
  ...
  GasStation.prototype.draw = function() {
    ...
    return this.game.c.fillText('G', this.parent.view[0] + this.parent.halfWidth, this.parent.view[1]);
  };
