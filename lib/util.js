var Util, abs, floor, isarr, max, min, ref, rnd, sqrt, trunc;

ref = [Math.abs, Math.floor, Array.isArray, Math.max, Math.min, Math.random, Math.sqrt, Math.trunc], abs = ref[0], floor = ref[1], isarr = ref[2], max = ref[3], min = ref[4], rnd = ref[5], sqrt = ref[6], trunc = ref[7];
...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Util = {
  ...
  magnitude: function(v) {
    ...
    return sqrt(v.reduce(function(p, n) {
      return p + n * n;
    }));
  },
