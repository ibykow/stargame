...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Sprite = (function() {
  ...
  Sprite.prototype.isInView = function() {
    ...
    cw = this.game.canvas.width / this.game.zoom;
    ch = this.game.canvas.height / this.game.zoom;
  ...
  Sprite.prototype.draw = function() {
    ...
    return this.game.c.fillRect((this.view[0] - this.width / 2) * this.game.zoom, (this.view[1] - this.height / 2) * this.game.zoom, this.width * this.game.zoom, this.height * this.game.zoom);
  };
