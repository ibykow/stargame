...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Sprite = (function() {
  ...
  Sprite.prototype.intersects = function(sprite) {
    ...
    ref1 = [sprite.position[0], sprite.position[0]], x = ref1[0], y = ref1[1];
    return (abs(this.position[0] - x) <= this.halfWidth + sprite.halfWidth) && (abs(this.position[1] - y) <= this.halfWidth + sprite.halfWidth);
  };
