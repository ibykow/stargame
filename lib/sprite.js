...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Sprite = (function() {
  ...
  Sprite.prototype.getCurrentView = function() {
    var limit, view;
    limit = [this.game.width, this.game.height];
    view = Util.toroidalDelta(this.position, this.game.viewOffset, limit);
    view[2] = this.position[2];
    return view;
  };
  ...
  Sprite.prototype.updateCollisions = function() {
    return this.collisions = this.detectCollisions(this.game.visibleSprites);
  };
