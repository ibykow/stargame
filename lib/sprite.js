...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Sprite = (function() {
  ...
  Sprite.prototype.isInView = function() {
    return (this.game.canvas != null) && (this.view[0] >= -this.halfWidth) && (this.view[1] >= -this.halfHeight) && (this.view[0] <= this.game.canvas.width + this.halfWidth) && (this.view[1] <= this.game.canvas.height + this.halfHeight);
  };

  Sprite.prototype.updateView = function() {
    this.view = [this.position[0] - this.game.viewOffset[0], this.position[1] - this.game.viewOffset[1], this.position[3]];
