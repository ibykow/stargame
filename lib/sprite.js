...
(typeof module !== "undefined" && module !== null ? module : {}).exports = Sprite = (function() {
  ...
  Sprite.prototype.filterCollided = function(sprites) {
    if (sprites == null) {
    ...
    return sprites.filter((function(_this) {
      return function(sprite) {
        return _this.isCollidedWith(sprite);
      };
    })(this));
  };

  Sprite.prototype.isCollidedWith = function(sprite) {
    if (this === sprite || !(sprite != null ? sprite.getBounds : void 0)) {
      return false;
    }
    return Util.areSquareBoundsOverlapped(this.getBounds(), sprite.getBounds());
  };

  Sprite.prototype.getBounds = function() {
    return [[this.view[0] - this.halfWidth, this.view[1] - this.halfHeight], [this.width, this.height]];
  };
  ...
  Sprite.prototype.updateCollided = function() {
    return this.collided = this.filterCollided();
  };
